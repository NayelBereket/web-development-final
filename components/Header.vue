<template>
    <header class="bg-gull-gray-700 py-2">
        <main class="container mx-auto flex w-full items-center justify-between py-4 px-6">
            ...
            <nav class="text-buttercup-500 flex flex-row justify-end gap-4">
